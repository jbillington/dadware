...
- The Trash is shown as an ordinary row in the folder chart, not as a section of its own — it is a folder, and routinely the largest one. It is **not graded**; the reasoning is in `CHANGELOG.md`.
